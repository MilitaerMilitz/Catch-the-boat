 ...
 * @version 1.0
 * This class Overrides the onAction Method of ChestGuiSlot to make nothing.
 */
public class EmptySlot extends ChestGuiSlot {
     ...
     */
    public EmptySlot(ItemStack stack, int position, @Nullable String name) {
